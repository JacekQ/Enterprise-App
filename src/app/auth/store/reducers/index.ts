...
export const getIsAdmin = createSelector(selectAuthStatusState, fromAuth.getIsAdmin);
export const getError = createSelector(selectAuthStatusState, fromAuth.getError);
export const getAuthStatus = createSelector(selectAuthStatusState, fromAuth.getAuthStatus);
